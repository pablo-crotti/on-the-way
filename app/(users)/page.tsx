...
/**
 * `Home` component serves as the main entry point for displaying podcast collections
 * and their latest episodes. It provides navigational features to slide through collections
 * and dynamically loads episode details. The component fetches data for all collections,
 * computes various properties such as the latest episode, and provides interactivity
 * for expanding text descriptions and navigating between collection slides.
 *
 * @component
 * @example
 * return (
...
export default function Home() {
   ...
   * and triggers fetching the last episode of the latest collection.
   */
  ...
  /**
   * Retrieves the last episode for a given collection and updates the state
   * with the episode details while filtering out any drafts.
   *
   * @param {number} number - The collection number to fetch episodes for.
   */
    ...
    return allCollections.map((collection, i) => {
      return (
        ...
        >
          ...
          <h1 className="text-center dark:text-white my-3">
            {collection.name}
          </h1>
          <a
  ...
  /**
   * Converts seconds to minutes, used for displaying episode durations.
   *
   * @param {number} seconds - The number of seconds to convert to minutes.
   * @returns {number} The converted minutes.
   */
      ...
      {loading ? (
        ...
        <div>
          ...
          <div className="p-4 md:px-40 xl:px-60 2xl:px-90">
            ...
            <p className="text-base text-darkbg-900 dark:text-white">
              {expandText
                ? lastCollection.description.slice(0, 300)
                : lastCollection.description}{" "}
              {lastCollection.description.length > 300 ? (
                <a
                  className="text-[#1C8D70] cursor-pointer"
                  onClick={() => setExpandText(!expandText)}
                >
                  {expandText ? "...Voir plus" : "Voir moins"}
                </a>
              ) : (
                ""
              )}{" "}
            ...
            <div className="flex justify-center mt-7">
              ...
              >
                <img
                  ...
                  alt=""
                />
                <h1 className="text-center dark:text-white mt-3">
                  {lastCollection.name}
                </h1>
          ...
          <div className="bg-[#B5D4C034] p-4 my-8 md:px-60 xl:px-80 2xl:px-96 ">
            ...
            <div className="carousel-container">
              ...
              <div id="controls">
                <span
                  className={`prev ${slideIndex == 0 ? "hidden" : ""}`}
                  onClick={prev}
                >
                  <svg
                    width="23"
                ...
                <span
                  className={`next flex flex-row-reverse ${
                    slideIndex == nbCollection - 1 ? "hidden" : ""
                  }`}
                  onClick={next}
                >
                  <svg
