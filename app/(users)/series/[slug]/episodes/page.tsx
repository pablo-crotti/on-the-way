...
export default function Page() {
  ...
  const [copyLabel, setCopyLabel] = useState<string>("Copier le lien")
  ...
  // Copies the current URL to the clipboard and updates the copy button label temporarily.
  const copyLink = () => {
    navigator.clipboard.writeText(currentUrl);
    setCopyLabel("Lien copié !");
    setTimeout(() => setCopyLabel("Copier le lien"), 1000)
  }
  ...
  return (
    <div>
      ...
      <div className="w-full mt-7 flex justify-center">
        <button onClick={() => setModalOpen(true)} className="flex flex-row gap-2 text-white bg-primary hover:bg-primarydark focus:ring-4 focus:outline-none focus:ring-primary font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="button">
        ...
        {modalOpen ? (
          <div className="bg-black/50 overflow-y-auto overflow-x-hidden fixed flex z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div className="relative p-4 w-full max-w-2xl max-h-full">
              <div className="relative bg-white rounded-lg shadow dark:bg-darkbg-700">
                <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-darkbg-600">
                  <h3 className="text-xl font-semibold text-darkbg-900 dark:text-white">
                    Partager l'épisode
                  </h3>
                  <button onClick={() => setModalOpen(false)} type="button" className="text-darkbg-400 bg-transparent hover:bg-darkbg-200 hover:text-darkbg-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-darkbg-600 dark:hover:text-white">
                ...
                <div className="p-4 md:p-5 space-y-4 flex flex-col">
                  <a href={`https://www.facebook.com/sharer.php?u=${encodeURI(currentUrl)}`} target="blank" className="flex flew-row justify-between bg-darkbg-50 dark:bg-darkbg-800 p-4 text-darkbg-700 dark:text-darkbg-200 rounded-lg hover:dark:bg-darkbg-600 hover:bg-darkbg-100">
                    Facebook
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
                    </svg>
                  </a>
                  <a href={`https://www.twitter.com/share?url=${encodeURI(currentUrl)}`} target="blank" className="flex flew-row justify-between bg-darkbg-50 dark:bg-darkbg-800 p-4 text-darkbg-700 dark:text-darkbg-200 rounded-lg hover:dark:bg-darkbg-600 hover:bg-darkbg-100">
                    X
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
                    </svg>
                  </a>
                  <a href={`https://www.linkedin.com/shareArticle?mini=true&url=${encodeURI(currentUrl)}`} target="blank" className="flex flew-row justify-between bg-darkbg-50 dark:bg-darkbg-800 p-4 text-darkbg-700 dark:text-darkbg-200 rounded-lg hover:dark:bg-darkbg-600 hover:bg-darkbg-100">
                    LinkedIn
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
                    </svg>
                  </a>
                  <button onClick={copyLink} className="flex flew-row justify-between bg-darkbg-50 dark:bg-darkbg-800 p-4 text-darkbg-700 dark:text-darkbg-200 rounded-lg hover:dark:bg-darkbg-600 hover:bg-darkbg-100">
                    {copyLabel}
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
