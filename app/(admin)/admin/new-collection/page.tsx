            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handelSubmit}>
              ...
              <div className="mt-6">
                ...
                <div className="flex gap-4">
                  ...
                  />
                  <input className="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-darkbg-400 focus:outline-none dark:bg-darkbg-700 dark:border-darkbg-600 dark:placeholder-darkbg-400"
                    id="placesUrl"
                    name="placesUrl"
                    type="text"
              ...
              <ul className="mt-6 max-w-md space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400">
                    {places.map((value: any, i: number) =>
                      value[0] == "" ? (
                        ...
                        <li key={i}>
                          {value[0]} : <span className="text-blue-500">{value[1]}</span>{" "}
                          <button
